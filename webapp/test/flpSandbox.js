					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Geschäftspartner auf einer Map anzeigen",
									"targetURL": "#bupamap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bupamap-display": {
								"semanticObject": "bupamap",
								"action": "display",
								"description": "Diese Fiori Applikation zeigt Geschäftspartner auf einer Map an.",
								"title": "Geschäftspartner auf einer Map anzeigen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bupamap",
									"url": sap.ui.require.toUrl("bupamap")
								}
							}
						}
					}
